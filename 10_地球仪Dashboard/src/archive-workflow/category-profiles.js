...
export const ARCHIVE_CATEGORY_PROFILES = Object.freeze({
  ...
  species: defineProfile('species', {
    ...
    indexFields: [
      ...
      defineIndexField('ecologyCode', '出现生态层', {
        type: 'select',
        referenceCategory: 'ecology',
        dynamicOptions: true,
        options: [
          { value: 'E01', label: 'E01 / 冰顶滴水层' },
          { value: 'E02', label: 'E02 / 冰壁甲壳带' },
          { value: 'E03', label: 'E03 / 蕨状低林层' },
          { value: 'E04', label: 'E04 / 暮色针叶层' },
          { value: 'E05', label: 'E05 / 黑湖水系' },
          { value: 'E06', label: 'E06 / 地热泥沼' },
          { value: 'E07', label: 'E07 / 根板与旧骨层' },
        ],
      }),
