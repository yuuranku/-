...
import { HZ6_WEB_LONGFORMS } from './hz6-web-content.js';
...
const organizations = [
  ...Object.values(ARCHIVE_LONGFORM.organizations).map((entry) => {
  ...
  return {
    ...
    system: false,
    webContent: ['O02', 'O05'].includes(entry.code),
  };
  }),
  {
    ...doc(
      'org-o24',
      'O24',
      '中国科学院地球物理研究所极地地球物理研究室',
      '中国科学院 / 国际地球物理年极地研究室',
      '中国科学院地球物理研究所极地地球物理研究室 / 机构档案',
      '1955年下半年成立的直属研究室，承接国际地球物理年时期的高纬与极地地球物理观测、资料处理、仪器研制和国际交换。',
      [['目录', '组织'], ['权限', '科研协作'], ['档案期', '1955—1958年']],
    ),
    lane: 'east',
    system: false,
    webContent: true,
...
const peopleRecords = [
  ['陈宗器', '极地地球物理研究室主任', '中国科学院地球物理研究所极地地球物理研究室 / 主任人员卷', '负责研究室筹建、日常管理、地磁方向、国际联络和野外任务总协调。'],
  ['赵九章', '地球物理研究所所长；极地室学术委员会主任', '中国科学院地球物理研究所极地地球物理研究室 / 学术委员会人员卷', '确定研究方向、批准重大任务和对苏合作，不兼任研究室主任。'],
  ['施雅风', '极地室联合副主任兼冰川与野外观测组组长（借调）', '中国科学院地球物理研究所极地地球物理研究室 / 冰川与野外人员卷', '负责冰川方法、野外队训练、路线记录和实地考察。'],
  ['陈述彭', '地图与资料组组长（借调）', '中国科学院地球物理研究所极地地球物理研究室 / 地图资料人员卷', '负责坐标、航片、图幅、资料编算和版本来源管理。'],
  ['陈宗基', '工程安全组组长／特聘顾问', '中国科学院地球物理研究所极地地球物理研究室 / 工程安全人员卷', '负责冻土、岩体、临时建筑和下降设施安全。'],
  ['竺可桢', '国际地球物理年中国委员会主任；研究室高级指导人', '中国科学院地球物理研究所极地地球物理研究室 / 高级指导人员卷', '负责国家级协调、科学院内部授权和跨研究所支持，不进入研究室日常编制。'],
  ['叶笃正', '极地室副主任兼高空大气与电离层组组长', '中国科学院地球物理研究所极地地球物理研究室 / 高空大气人员卷', '负责高空大气、环流、电离层、极光和无线电传播。'],
  ['侯学煜', '生态与生物样本顾问', '中国科学院地球物理研究所极地地球物理研究室 / 生态样本人员卷', '负责极地生态、植被和异常生物样本的科学鉴定。'],
  ['刘东生', '地质与样本组组长（联合课题）', '中国科学院地球物理研究所极地地球物理研究室 / 地质样本人员卷', '负责沉积、古环境、地层和样本独立判读。'],
  ...
  ['米哈伊尔·索莫夫', '局长、局务委员会主席', 'USVR / 局长人员卷', '制度创建者和最高负责人；负责年度行动、重大井线与路线审批、跨部门协调。'],
  ['阿列克谢·特列什尼科夫', '第一副局长，分管作业与运输', 'USVR / 第一副局长人员卷', '掌握日常行动能力，分管计划处、运输处、前线站网和越冬轮换。'],
  ['叶夫根尼·托尔斯季科夫', '副局长，分管特别作业', 'USVR / 特别作业人员卷', '负责深部行动、事故处置、搜救与失联人员认领；保留命令链责任冲突。'],
  ['安德烈·卡皮察', '科学技术处副处长兼地球物理科科长', 'USVR / 科学技术处人员卷', '负责地震测深、空腔边界推定和测线设计。'],
  ['弗拉基米尔·科特利亚科夫', '科学技术处冰川科科长', 'USVR / 科学技术处人员卷', '负责冰盖运动、质量平衡、路线稳定性和越冬观测制度。'],
  ['米哈伊尔·拉维奇', '科学技术处处长', 'USVR / 科学技术处人员卷', '主持地质、地球物理、冰川和热物理的综合判读与工程论证。'],
  ['伊戈尔·佐季科夫', '热物理研究室主任', 'USVR / 科学技术处人员卷', '负责热流、底部融化、冰下水系及异常热源的常规解释模型。'],
  ['弗拉基米尔·别洛乌索夫', '副局长，分管科学技术；兼科学技术委员会主任', 'USVR / 副局长人员卷', '承担最高科学会签与对外科学接口，不负责日常科室管理。'],
  ['霍华德·P·拉斯克', '野外队长', 'HZ-6 / 任务人员卷', '负责路线与前方安全；美国海军借调，携带 M1 卡宾枪。', '/assets/hz6/people/hz6-p28-howard-rusk.png'],
  ['海伦·M·克莱恩', '生物员', 'HZ-6 / 任务人员卷', '负责黑针木根板、白壳虫和滤芯样本。', '/assets/hz6/people/hz6-p29-helen-klein.png'],
  ['丹尼尔·基恩', '无线电员', 'HZ-6 / 任务人员卷', '负责 AN/PRC-10 电台和定时通联。', '/assets/hz6/people/hz6-p30-daniel-keene.png'],
  ['托马斯·E·马洛里', '摄影师', 'HZ-6 / 任务人员卷', 'BAS 民用影像技术员；正常队形中位于四号位。', '/assets/hz6/people/hz6-p31-thomas-mallory.png'],
  ['塞缪尔·R·万斯', '队尾护卫', 'HZ-6 / 任务人员卷', '负责后方安全；美国海军借调，携带第二支 M1 卡宾枪。', '/assets/hz6/people/hz6-p32-samuel-vance.png'],
  ['叶夫根尼·马特维耶维奇·苏久莫夫', '办公室主任兼计划处负责人', 'USVR / 办公室与计划处人员卷', '负责局务会议、命令整理、年度计划、跨部门协调和对外联络；在筹备阶段兼管计划处。'],
  ['阿尔卡季·费奥多罗维奇·尼古拉耶夫', '工程处处长', 'USVR / 工程处人员卷', '统辖极地设计、施工、机电、装备和验收；其履历支持冰雪施工与远程履带行动。'],
  ['伊万·亚历山德罗维奇·曼', '运输处副处长兼海运科科长', 'USVR / 运输处人员卷', '负责船舶、港口装载、沿岸卸货、海冰判断和特殊货物转运。'],
  ['伊万·伊万诺维奇·切列维奇内', '航空处处长', 'USVR / 航空处人员卷', '掌握侦察、空投、冰面机场、内陆飞行和搜救的实际指挥。'],
  ['亚历山大·费奥多罗维奇·古谢夫', '泰加站管理处主任；后兼内陆站务总监', 'USVR / 泰加站人员卷', '管理越冬人员、前线站务、物资分配和现场行动许可。'],
  ['列昂尼德·伊万诺维奇·罗戈佐夫', '卫生处现场医疗科副科长；站点医疗制度顾问', 'USVR / 卫生处人员卷', '建立单医师站点、冬季无法撤离和极端外科应急制度。'],
  ['弗拉基米尔·格里戈里耶维奇·科尔特', '科学技术委员会副主任', 'USVR / 科学技术委员会人员卷', '主管海洋与对外科学协作，参加重大会签但不负责局内日常科室。'],
  ['马克·伊万诺维奇·舍韦廖夫', '航空事务高级顾问', 'USVR / 航空顾问人员卷', '为USVR取得飞机、航线和跨部门航空支持，不占普通航空处长编制。'],
  ['伊万·德米特里耶维奇·帕帕宁', '局务委员会外部委员、科学院资源协调人', 'USVR / 外部协调人员卷', '以科研船、预算外壳和科学院系统支持为USVR提供外部资源协调。'],
  ['顾功叙', '极地室副主任，分管地震重力与仪器技术', '中国科学院地球物理研究所极地地球物理研究室 / 副主任人员卷', '负责物探方法、设备体系、地震与重力组及仪器技术组。'],
  ['傅承义', '地震与重力组学术负责人', '中国科学院地球物理研究所极地地球物理研究室 / 地震重力人员卷', '负责地震理论、弹性波和深部结构的专业审查。'],
  ['李善邦', '地震观测负责人兼仪器技术组副组长', '中国科学院地球物理研究所极地地球物理研究室 / 仪器技术人员卷', '负责台站观测、野外地震记录和仪器研制维护。'],
  ['朱岗昆', '电离层专业负责人', '中国科学院地球物理研究所极地地球物理研究室 / 电离层人员卷', '负责电离层观测、技术标准和国际资料交换。'],
  ['吕保维', '无线电传播与通信技术负责人', '中国科学院地球物理研究所极地地球物理研究室 / 通信技术人员卷', '负责高纬通信、电波传播和野外通信技术。'],
];

const polarLabPersonNames = new Set([
  '陈宗器', '赵九章', '施雅风', '陈述彭', '陈宗基', '竺可桢', '叶笃正', '侯学煜', '刘东生',
  '顾功叙', '傅承义', '李善邦', '朱岗昆', '吕保维',
]);
...
const people = peopleRecords.map(([name, role, meta, note, image], index) => ({
  ...
  image,
  webContent: meta.startsWith('HZ-6 /') || meta.startsWith('USVR /') || polarLabPersonNames.has(name),
}))
  // 仅保留本次设定文件列出的人员，以及 HZ-6 的任务成员；其余旧人物卷不再入库。
  .filter((person) => person.webContent)
...
const eventRecords = [
  ...
  ['EV10', '1952.11.18', 'HZ-6 / 样本线任务', '五人小队自地平线站进入 HZ-6A—HZ-6C 暮色针叶层，返程时发生未分类林下接触。任务后仅摄影师马洛里生还。', '/assets/hz6/photos/hz6-r06-f01.png', '任务报告 / 1952 HZ-6 中文译本'],
  ['EV11', '1952.11.19', '地平线站 / 影像室双重签收', '一卷返程中的野外影像尚未抵站，影像室却已完成同编号封套的接收、称重与双人签字。记录时间早于救援队抵站三小时，现仅保留签收链索引。', '/assets/archive/event-deepfreeze-466.webp', '影像交接卷 / 签收先行'],
...
const abnormalities = [
  ...
  ['1964.11.06', '西线未施工路段', '南极公约监管办公室西线复核区', '调查组带回一条已投入使用的四十公里交通线记录；工程档案证明该路线从未获批、未领料，也从未施工。', '地理闭合失败', 'critical'],
...
export const ARCHIVE_ROOTS = [
  ...
  // 已录入正文的档案优先显示；同一状态内保留原始档案序列。
  children: children
    .map((archive, index) => sealArchiveRecord(id, archive, index))
    .sort((first, second) => Number(Boolean(second.webContent)) - Number(Boolean(first.webContent))),
}));
