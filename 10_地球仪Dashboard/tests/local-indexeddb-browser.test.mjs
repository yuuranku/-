...
test('legacy IndexedDB state and valid v1 snapshots gain workspace stores without losing drafts or archives', { timeout: 20_000 }, async () => {
  ...
  try {
    ...
    const result = await page.evaluate(async ({ seed, principal }) => {
      ...
      delete legacyState.mainlineVersions;
      delete legacyState.mainlineStaffSlots;
      ...
      delete v1.payload.mainlineVersions;
      delete v1.payload.mainlineStaffSlots;
      ...
      return {
        ...
        stateUpgrade: {
          ...
          mainlineVersions: exportedAfterStateUpgrade.payload.mainlineVersions,
          mainlineStaffSlots: exportedAfterStateUpgrade.payload.mainlineStaffSlots,
        },
        snapshotUpgrade: {
          ...
          mainlineVersions: upgraded.payload.mainlineVersions,
          mainlineStaffSlots: upgraded.payload.mainlineStaffSlots,
